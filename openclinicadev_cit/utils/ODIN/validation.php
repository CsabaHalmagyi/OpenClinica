...
for($row = 1; $row <= $highestRow; $row ++) {
	...
	//	$plaintext = $sheet->getCellByColumnAndRow ( $row, $col )->getFormattedValue();
	//	array_push ( $rowdata, $plaintext );
	//}
...
if (empty ( $errors )) {
	...
	$_SESSION['csvdata'] = $excelData;
	$_SESSION['csvmaxrow'] = $highestRow;
	$_SESSION['csvmaxcol'] = $highestColumn;
